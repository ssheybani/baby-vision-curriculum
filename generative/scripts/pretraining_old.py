...
# Total number of frames in each age group: g0=1.68m, g1=1.77m, g2=1.45m
    ...
    datasets = make_dataset(g1, seq_len=seq_len, jpg_root=jpg_root, ds_rate=ds_rate, n_groupframes=n_groupframes, image_size=image_size)
...
#         break
    ...
    if is_main_process():
        results_fpath = os.path.join(model_dir,"train_val_scores_g1")

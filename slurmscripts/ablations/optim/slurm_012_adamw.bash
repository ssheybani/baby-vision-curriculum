...
#SBATCH --job-name=job_012aw_223
#SBATCH --output=job_012aw_223_Out
#SBATCH --error=job_012aw_223_Err
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/ablations/optim/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/ablations/optim/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/ablations/optim/'

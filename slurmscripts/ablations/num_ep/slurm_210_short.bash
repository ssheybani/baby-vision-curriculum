...
#SBATCH --job-name=job_210_223
#SBATCH --output=job_210_223_Out
#SBATCH --error=job_210_223_Err
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/ablations/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/ablations/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/ablations/'

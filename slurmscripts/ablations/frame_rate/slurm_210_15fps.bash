...
#SBATCH --job-name=job_210ds2_223
#SBATCH --output=job_210ds2_223_Out
#SBATCH --error=job_210ds2_223_Err
...
data_seed=223 # Modify this for different runs: 221, 222, 223
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/ablations/frame_rate/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/ablations/frame_rate/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/ablations/frame_rate/'

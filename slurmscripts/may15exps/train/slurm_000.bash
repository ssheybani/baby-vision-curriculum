...
#SBATCH --job-name=job_000_721
#SBATCH --output=job_000_721_Out
#SBATCH --error=job_000_721_Err
...
data_seed=721 # Modify this for different runs: 661, 662, 663
...
savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may15/s1/'
...
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may15/s1/'
...
uctask='ucf101'
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may15/s1/'
ucframe_rate=10
ucbatch_size=64
# prot_name=$train_group
# seed=$data_seed
...
fold=0
other_seed=10
#other_seed=fold(s0)fold(s1)
other_id='_adamw_pre.g0'

savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may15/s2/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may15/s2/'
...
##----------------------------
# Compute UCF101 Embeddings
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may15/s2/'
# prot_name=$train_group
# seed=$data_seed
# num_workers=6
...
fold=1
other_seed=101
other_id='adamw_pre.g0g0'

savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may15/s3/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may15/s3/'
...
##----------------------------
# Compute UCF101 Embeddings
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may15/s3/'
# prot_name=$train_group
# seed=$data_seed
# num_workers=6

...
#SBATCH --job-name=job_g0f10
#SBATCH --output=job_g0f10_Out
#SBATCH --error=job_g0f10_Err
...
data_seed=201 # Modify this for different runs: 401, 402, 403

...
#SBATCH --job-name=job_t2sgd
#SBATCH --output=job_t2sgd_Out
#SBATCH --error=job_t2sgd_Err
...
init_checkpoint_path="${ch_dir}s1/model_g2_seed_211_other_211_30fps_10ep_sgd.pt"
prot_name='g2'
architecture='base'

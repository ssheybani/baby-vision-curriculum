...
#SBATCH --job-name=job_g21
#SBATCH --output=job_g21_Out
#SBATCH --error=job_g21_Err
...
init_checkpoint_path="${ch_dir}s2/model_g1_seed_1133_other_1345_mask50_small2_pre.g2.pt"

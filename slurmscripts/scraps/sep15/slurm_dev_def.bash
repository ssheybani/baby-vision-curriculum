...
#SBATCH --job-name=job_0_d112
#SBATCH --output=job_0_d112_Out
#SBATCH --error=job_0_d112_Err
...
folder_id='aug15'
seed=153 # Modify this for different runs: 681-683
...
python /N/project/baby_vision_curriculum/github/baby-vision-curriculum/pretraining/predictive/scripts/pretrain_vjepa_v1.1.py -train_group $train_group -jpg_root $jpg_root -savedir $savedir --init_checkpoint_path $init_checkpoint_path --ds_rate $ds_rate --lr $lr --wd $wd --batch_size $batch_size --architecture $architecture --n_epoch $n_epoch --seed $seed --run_id $run_id --optim $optim --condition $condition --fold $fold --num_frames $num_frames --n_trainsamples $n_trainsamples --max_epoch_iters $max_epoch_iters --tubelet_size $tubelet_size --pred_mask_scale $pred_mask_scale --allow_overlap $allow_overlap --momentum $momentum --enc_mask_scale $enc_mask_scale --interval $interval --augs $augs

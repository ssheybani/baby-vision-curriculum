...
#SBATCH --job-name=job_0_d167
#SBATCH --output=job_0_d167_Out
#SBATCH --error=job_0_d167_Err
...
folder_id='aug65'
seed=167 # Modify this for different runs: 681-683
...
# 6
batch_size=32
max_epoch_iters=3000
n_trainsamples=384000

...
#SBATCH --job-name=job_g210402
#SBATCH --output=job_g210402_Out
#SBATCH --error=job_g210402_Err
...
#g0g1
init_checkpoint_path="${ch_dir}s3/model_g0_seed_402_other_402_3ep_pre.g2g1.pt"
prot_name='g2g1g0'

...
#SBATCH --job-name=job_g012403
#SBATCH --output=job_g012403_Out
#SBATCH --error=job_g012403_Err
...
#g0g1
init_checkpoint_path="${ch_dir}s3/model_g2_seed_403_other_403_3ep_pre.g0g1.pt"
prot_name='g0g1g2'

...
#SBATCH --job-name=job_000_663
#SBATCH --output=job_000_663_Out
#SBATCH --error=job_000_663_Err
...
data_seed=663 # Modify this for different runs: 661, 662, 663
...
savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may14/s1/tmp/'
...
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may14/s1/'
...
other_id='_sgd_pre.g0'

savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may14/s2/tmp/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may14/s2/'
...
fold=1
other_seed=101
other_id='sgd_pre.g0g0'

savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may14/s3/tmp/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may14/s3/'
...
##----------------------------
# Compute UCF101 Embeddings
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may14/s3/'
# prot_name=$train_group
# seed=$data_seed
# num_workers=6

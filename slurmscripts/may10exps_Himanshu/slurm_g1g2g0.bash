...
#SBATCH --job-name=job_g120s503
#SBATCH --output=job_g120s503_Out
#SBATCH --error=job_g120s503_Err
...
data_seed=503 # Modify this for different runs: 401, 402, 403

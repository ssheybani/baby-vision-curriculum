...
#SBATCH --job-name=job_g312s402
#SBATCH --output=job_g312s402_Out
#SBATCH --error=job_g312s402_Err
...
data_seed=402 # Modify this for different runs: 401, 402, 403

...
#SBATCH --job-name=job_g312211
#SBATCH --output=job_g312211_Out
#SBATCH --error=job_g312211_Err
...
init_checkpoint_path="${ch_dir}s3/model_g2_seed_211_other_211_sgd_pre.g3g1.pt"

...
#SBATCH --job-name=job_grrr_213
#SBATCH --output=job_grrr_213_Out
#SBATCH --error=job_grrr_213_Err
...
seed=213
prot_name='grgrgr'
init_checkpoint_path="${ch_dir}s3/model_gr_seed_213_other_213_sgd_pre.grgr.pt"

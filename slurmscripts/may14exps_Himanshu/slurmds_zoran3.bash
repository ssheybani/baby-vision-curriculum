...
#SBATCH --job-name=job_g210_212
#SBATCH --output=job_g210_212_Out
#SBATCH --error=job_g210_212_Err
...
seed=212
prot_name='g2g1g0'
init_checkpoint_path="${ch_dir}s3/model_g0_seed_212_other_212_sgd_pre.g2g1.pt"

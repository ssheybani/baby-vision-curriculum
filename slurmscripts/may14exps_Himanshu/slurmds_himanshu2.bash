...
#SBATCH --job-name=job_g210_213
#SBATCH --output=job_g210_213_Out
#SBATCH --error=job_g210_213_Err
...
seed=213
prot_name='g2g1g0'
init_checkpoint_path="${ch_dir}s3/model_g0_seed_213_other_213_sgd_pre.g2g1.pt"

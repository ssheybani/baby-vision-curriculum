...
#SBATCH --job-name=job_g312_213
#SBATCH --output=job_g312_213_Out
#SBATCH --error=job_g312_213_Err
...
seed=213
prot_name='g3g1g2'
init_checkpoint_path="${ch_dir}s3/model_g2_seed_213_other_213_sgd_pre.g3g1.pt"

...
#SBATCH --job-name=job_g012_212
#SBATCH --output=job_g012_212_Out
#SBATCH --error=job_g012_212_Err
...
seed=212
prot_name='g0g1g2'
init_checkpoint_path="${ch_dir}s3/model_g2_seed_212_other_212_sgd_pre.g0g1.pt"

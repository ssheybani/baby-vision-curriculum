...
#SBATCH --job-name=job_grrr211
#SBATCH --output=job_grrr211_Out
#SBATCH --error=job_grrr211_Err
...
init_checkpoint_path="${ch_dir}s3/model_gr_seed_211_other_211_sgd_pre.grgr.pt"

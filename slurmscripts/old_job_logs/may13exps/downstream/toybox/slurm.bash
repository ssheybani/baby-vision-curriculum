...
#SBATCH --job-name=job_t0sgd
#SBATCH --output=job_t0sgd_Out
#SBATCH --error=job_t0sgd_Err
...
init_checkpoint_path="${ch_dir}s1/model_g0_seed_211_other_211_30fps_10ep_sgd.pt"
prot_name='g0'
architecture='base'
other_id='10ep_30fps_base_sgd'
seed=211
frame_rate=5
...
#-------
# init_checkpoint_path="${ch_dir}s1/model_g2_seed_201_other_201_15fps_10ep_base.pt"
# prot_name='g2'
# architecture='base'
# seed=201
# frame_rate=5
# other_id='10ep_15fps_base_tb5fps'

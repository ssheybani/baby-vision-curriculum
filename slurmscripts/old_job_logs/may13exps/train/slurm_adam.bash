...
#SBATCH --job-name=job_g2adam
#SBATCH --output=job_g2adam_Out
#SBATCH --error=job_g2adam_Err
...
data_seed=211 # Modify this for different runs: 401, 402, 403

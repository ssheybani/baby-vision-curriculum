...
#SBATCH --job-name=job_000_926
#SBATCH --output=job_000_926_Out
#SBATCH --error=job_000_926_Err
...
data_seed=926 # Modify this for different runs: 681-683
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/jun9/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/jun9/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/jun9/'

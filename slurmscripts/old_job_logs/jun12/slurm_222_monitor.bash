...
#SBATCH --job-name=job_222_143
#SBATCH --output=job_222_143_Out
#SBATCH --error=job_222_143_Err
...
data_seed=143 # Modify this for different runs: 681-683
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/jun12/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/jun12/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/jun12/'
...
script='pretrain_videomae_2.4.py'


python /N/project/baby_vision_curriculum/github/baby-vision-curriculum/generative/scripts/pretrain_videomae_v2.4.py -train_group $train_group -jpg_root $jpg_root -savedir $savedir --init_checkpoint_path $init_checkpoint_path --ds_rate $ds_rate --mask_ratio $mask_ratio --lr $lr --wd $wd --batch_size $batch_size --architecture $architecture --n_epoch $n_epoch --data_seed $data_seed --other_seed $other_seed  --script $script --other_id $other_id --optim $optim  --momentum $momentum --condition $condition --monitor $monitor --fold $fold --num_frames $num_frames --n_trainsamples $n_trainsamples --mask_sampler $mask_sampler

...
#SBATCH --job-name=job_0_246
#SBATCH --output=job_0_246_Out
#SBATCH --error=job_0_246_Err
...
folder_id='jul251'
seed=246 # Modify this for different runs: 681-683
...
savedir="/N/project/baby_vision_curriculum/trained_models/predictive/v0/${folder_id}/"
tbsavedir="/N/project/baby_vision_curriculum/trained_models/predictive/v0/${folder_id}/benchmarks/toybox/"
ucsavedir="/N/project/baby_vision_curriculum/trained_models/predictive/v0/${folder_id}/benchmarks/ucf101/"
...
python /N/project/baby_vision_curriculum/github/baby-vision-curriculum/predictive/scripts/pretrain_vjepa_v0.py -train_group $train_group -jpg_root $jpg_root -savedir $savedir --init_checkpoint_path $init_checkpoint_path --ds_rate $ds_rate --lr $lr --wd $wd --batch_size $batch_size --architecture $architecture --n_epoch $n_epoch --seed $seed --run_id $run_id --optim $optim --condition $condition --fold $fold --num_frames $num_frames --n_trainsamples $n_trainsamples --max_epoch_iters $max_epoch_iters --tubelet_size $tubelet_size --pred_mask_scale $pred_mask_scale --allow_overlap $allow_overlap --momentum $momentum --enc_mask_scale $enc_mask_scale

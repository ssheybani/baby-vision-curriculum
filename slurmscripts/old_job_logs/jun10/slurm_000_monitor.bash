...
#SBATCH --job-name=job_000_927
#SBATCH --output=job_000_927_Out
#SBATCH --error=job_000_927_Err
...
data_seed=927 # Modify this for different runs: 681-683
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/jun10/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/jun10/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/jun10/'

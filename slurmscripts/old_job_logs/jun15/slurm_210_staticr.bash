...
#SBATCH --job-name=job_210str_155
#SBATCH --output=job_210str_155_Out
#SBATCH --error=job_210str_155_Err
...
data_seed=155 # Modify this for different runs: 681-683
# to avoid race condition with the other scripts.
sleep_duration=$((180 * ((data_seed+1) % 3)))
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/jun15/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/jun15/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/jun15/'

#@@@@@ debug. also fix the i_break in the code
n_epoch=5
curr='adev'
condition='static'
other_id="${curr}_${condition}_randmask"
monitor='grad'
ds_rate=1
num_frames=16
batch_size=16

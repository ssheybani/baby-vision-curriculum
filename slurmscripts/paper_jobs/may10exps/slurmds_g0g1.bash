...
#SBATCH --job-name=job_g01403
#SBATCH --output=job_g01403_Out
#SBATCH --error=job_g01403_Err
...
#g0g1
init_checkpoint_path="${ch_dir}s2/model_g1_seed_403_other_403_3ep_pre.g0.pt"
prot_name='g0g1'

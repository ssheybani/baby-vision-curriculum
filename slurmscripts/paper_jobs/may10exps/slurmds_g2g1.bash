...
#SBATCH --job-name=job_g21402
#SBATCH --output=job_g21402_Out
#SBATCH --error=job_g21402_Err
...
#g0g1
init_checkpoint_path="${ch_dir}s2/model_g1_seed_402_other_402_3ep_pre.g2.pt"
prot_name='g2g1'

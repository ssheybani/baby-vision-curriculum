...
#SBATCH --job-name=job_g312401
#SBATCH --output=job_g312401_Out
#SBATCH --error=job_g312401_Err
...
#g0g1
init_checkpoint_path="${ch_dir}s3/model_g2_seed_401_other_401_3ep_pre.g3g1.pt"
prot_name='g3g1g2'

...
#SBATCH --job-name=job_012_223l
#SBATCH --output=job_012_223l_Out
#SBATCH --error=job_012_223l_Err
...
saveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/ablations/num_ep/'
tbsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/ablations/num_ep/'
ucsaveroot='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/ablations/num_ep/'

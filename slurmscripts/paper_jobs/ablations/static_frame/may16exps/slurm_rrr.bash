...
#SBATCH --job-name=job_rrr_412
#SBATCH --output=job_rrr_412_Out
#SBATCH --error=job_rrr_412_Err
...
data_seed=412 # Modify this for different runs: 211, 212, 213
...
savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may16/s1/'
...
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may16/s1/'
...
uctask='ucf101'
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may16/s1/'
ucframe_rate=10
ucbatch_size=64
# prot_name=$train_group
# seed=$data_seed
...
savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may16/s2/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may16/s2/'
...
##----------------------------
# Compute UCF101 Embeddings
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may16/s2/'
# prot_name=$train_group
# seed=$data_seed
# num_workers=6
...
train_group='gr'
other_id='sgd_pre.grgr'

savedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/may16/s3/'
...
##----------------------------
# Compute ToyBox Embeddings
tbsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/toybox/may16/s3/'
...
##----------------------------
# Compute UCF101 Embeddings
ucsavedir='/N/project/baby_vision_curriculum/trained_models/generative/v2/benchmarks/ucf101/may16/s3/'
# prot_name=$train_group
# seed=$data_seed
# num_workers=6

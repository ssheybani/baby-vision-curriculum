...
#SBATCH --job-name=job_0_d113
#SBATCH --output=job_0_d113_Out
#SBATCH --error=job_0_d113_Err
...
folder_id='aug11'
seed=113 # Modify this for different runs: 681-683
...
python /N/project/baby_vision_curriculum/github/baby-vision-curriculum/generative/scripts/pretrain_videomae_v3.1.py -jpg_root $jpg_root -train_group $train_group -init_checkpoint_path $init_checkpoint_path -savedir $savedir --ds_rate $ds_rate --lr $lr --momentum $momentum --wd $wd --batch_size $batch_size --architecture $architecture --n_epoch $n_epoch --seed $seed --optim $optim --condition $condition --fold $fold --num_frames $num_frames --n_trainsamples $n_trainsamples --max_epoch_iters $max_epoch_iters --tubelet_size $tubelet_size --run_id $run_id --mask_sampler $mask_sampler --mask_ratio $mask_ratio --keep_val $keep_val

...
#SBATCH --job-name=job_0_st316
#SBATCH --output=job_0_st316_Out
#SBATCH --error=job_0_st316_Err
...
folder_id='jul315'
seed=316 # Modify this for different runs: 681-683
...
curr='dev'
train_group='g0'
condition='MatchedSpatioTemporal'
ds_rate=1
tubelet_size=1
num_frames=$((1*tubelet_size))
tbframe_rate=5
ucframe_rate=10
ssframe_rate=6
batch_size=16

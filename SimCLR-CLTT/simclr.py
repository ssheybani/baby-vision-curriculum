...
class SimCLR(pl.LightningModule):
    ...
    def nt_xent_loss(self, out_1, out_2, temperature, eps=1e-6):
        ...
        sim = torch.exp(cov / temperature) # denominator part of the loss function, since out_1 and out_2 has 512 dim in their shape, which means it corresponds to the entire batch.

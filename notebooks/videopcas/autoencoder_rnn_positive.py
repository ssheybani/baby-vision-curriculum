# the working zone of the deep net is 0-1 instead of [-1,1]
import sys, os
...
#     ds_rate = 1
    ...
    n_samples = args.num_samples # total num samples in the dataset
...
# print(len(image_paths[50]))
    ...
    model = RecAutoencoder(input_size, hidden_size, seq_len, num_rnnlayers=num_rnnlayers)
